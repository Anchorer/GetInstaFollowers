...
public class Consts {
    ...
    public static final String TAG = "GetFollowers";
...
//    public static final String API_BASE_URL = "https://i.instagram.com/api/v1/";
    ...
    public static final String HEADER_USER_AGENT = "User-Agent: Instagram 9.2.0 Android (18/4.3; 320dpi; 720x1280; Xiaomi; HM 1SW; armani; qcom; en_US";
}
